Pod::Spec.new do |s|
  ...
  s.version          = "2.0.0"
  s.summary          = "A structure to provide immutable data to your views. When you change data you get update to apply. Ready to be your UITableView or your UICollectionView data source."
  s.description      = <<-DESC
